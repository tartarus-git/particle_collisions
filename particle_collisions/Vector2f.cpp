...
Vector2f Vector2f::operator/(float divisor) const noexcept { return Vector2f(x / divisor, y / divisor); }

Vector2f& Vector2f::operator/=(float divisor) noexcept { x /= divisor; y /= divisor; return *this; }
